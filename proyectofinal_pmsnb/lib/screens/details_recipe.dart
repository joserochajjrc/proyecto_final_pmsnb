                ...
                flexibleSpace: Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(widget.recipeModel.image.toString())
                    )
                  ),
                  child: Container(
                        ...
                        Column(
                          children: [
                            ...
                            FutureBuilder<List<ingredientsModel>>(
                              future: apiSpoonacular.getIngredients(widget.recipeModel.id.toString()),
                              builder: (BuildContext context, AsyncSnapshot<List<ingredientsModel>?> snapshot) {
