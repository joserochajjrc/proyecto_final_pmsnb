                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 7),
                        Text(recipeModel.healthScore.toString()+"%", style: TextStyle(color: Colors.white),),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 7),
                        Text(recipeModel.readyInMinutes.toString()+"min", style: TextStyle(color: Colors.white),),
                      ],
                    ),
                  )
                ],
